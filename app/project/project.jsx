      ...
      <div className={variables.listProjects}>
        <div className={variables.project}>
          ...
          <div className={variables.projectDesc}>
            <h1>GymSync</h1>
            <p>
              GymSync is a fitness-oriented term that could be associated with
              activities related to synchronizing or coordinating workouts,
              exercise routines, or fitness tracking. It might involve the
              integration of technology, apps, or devices to streamline and
              optimize fitness experiences.{" "}
            </p>
            <div className={variables.linkProject}>
              <Link
                href="https://gymsync.vercel.app/"
                target="_blank"
              ...
              <Link
                href="https://github.com/RidloGhifary/gymsync"
                target="_blank"
                className={variables.projectLink}>
        ...
        <div className={variables.project}>
          ...
          <div className={variables.projectDesc}>
            ...
            <div className={variables.linkProject}>
              <Link
                href="https://car-rental-fawn-iota.vercel.app/"
                target="_blank"
                className={variables.projectLink}>
                <ArrowSquareOut size={28} color="#cfd0d5" weight="bold" />
                <span>Demo</span>
              ...
              <Link
                href="https://github.com/RidloGhifary/car-rental"
                target="_blank"
                className={variables.projectLink}>
                <GithubLogo size={28} color="#cfd0d5" weight="fill" />
                <span>Code</span>
